...
class ArticleHtmlController @Inject constructor(private val resources: Resources) {
...
//            }
    ...
    private fun customCssBundleNode(): Element {
        val cssBytes = resources.openRawResource(R.raw.custom_bundle_css).readBytes()
    ...
    private fun customJsBundle(): Element {
        val jsBytes = resources.openRawResource(R.raw.custom_bundle_js).readBytes()
