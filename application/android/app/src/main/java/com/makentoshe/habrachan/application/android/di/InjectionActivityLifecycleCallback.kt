...
import com.makentoshe.habrachan.application.android.screen.comments.di.CommentsInjectingFragmentLifecycleCallback
...
class InjectionActivityLifecycleCallback : Application.ActivityLifecycleCallbacks {
    ...
    override fun onActivityCreated(activity: Activity, savedInstanceState: Bundle?) {
        ...
        val articleCommentsCallback = CommentsInjectingFragmentLifecycleCallback()
