...
@EpoxyModelClass(layout = R.layout.article_fragment_content_native_item_text)
abstract class TextArticleEpoxyModel : EpoxyModelWithHolder<TextArticleEpoxyModel.ViewHolder>() {
